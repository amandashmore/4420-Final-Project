...
# columnwise mans and sd on training data
...
# same transformation on test data using traning means and sds
...
# 9: Probability density visualization
```{r}
# converting to data frame
df <- data.frame(prob = as.numeric(y_prob),
                 actual = factor(y_test, labels = c("No Churn", "Churn")))
